                ...
                <br />
                 <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <asp:Label ID="lb_datosEncuesta" runat="server" Text=""></asp:Label>
                        </div>
                        <div class="modal-footer">
                            <asp:LinkButton ID="Link_MostrarEncuesta" runat="server" CssClass="btn btn-primary btn-block" OnClick="Link_MostrarEncuesta_Click" >Mostrar Encuesta</asp:LinkButton>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-2">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4>
                                <asp:Label ID="lb_numeropad" runat="server" Text=""></asp:Label></h4>
                        </div>
                        <div class="modal-body">
